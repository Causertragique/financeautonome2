...
shared/                   # Types used by both frontend & server
...
- **Hot reload**: Both frontend and server code
...
### Shared Types
Import consistent types in both frontend and server:
```typescript
...
```bash
pnpm dev        # Start dev server (frontend + server)
...
- **Cloud Deployment**: Use Firebase Hosting or Vercel via their MCP integrations for easy deployment. Both providers work well with this starter template.

## Architecture Notes

- Single-port development with Vite + Express integration
- TypeScript throughout (frontend, server, shared)
